...
def available():
    ...
    return render_template('available.html', logged_in_user=logged_in_user, available=available, notifications=notifications, sender_dict=sender_dict, receiver_dict=receiver_dict)
